...
<head>
    ...
    <title>Contact us - RK Mini Bank</title>
</head>
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            ...
            <div class="container"
                style=" backdrop-filter: blur(5px);  border-radius:0px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
                <form action="contact_us.php" method="post">
                    ...
                    <textarea name="message" class="" style="border-radius:0px; padding: 5px 5px 5px 15px;"
