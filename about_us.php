...
<head>
    ...
    <title>About us - RK Mini Bank</title>
...
<body style="background-color:black;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:0px;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <br><br>
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Rupali kudal</h1>
            <p style="color:white;"><b>February Intern at Sparks Foundation <br>SND College of Engineering & RC Yeola</b></p>
    </center>
